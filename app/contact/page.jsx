        ...
        <div className="space-y-4">
          <div className="rounded-[var(--radius-card)] bg-[var(--color-navy)] p-7 text-white shadow-[var(--shadow-lifted)]">
            ...
            <div className="mt-7 space-y-5 text-sm">
              <a href="mailto:hello@littlehaven.example" className="flex items-center gap-3 text-white/85 transition-colors hover:text-[var(--color-mint)]"><Mail size={17} aria-hidden="true" /> hello@littlehaven.example</a>
              <a href="tel:+18005550142" className="flex items-center gap-3 text-white/85 transition-colors hover:text-[var(--color-mint)]"><Phone size={17} aria-hidden="true" /> +1 (800) 555-0142</a>
